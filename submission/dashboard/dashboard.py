...
def sidebar(df):
    ...
    with st.sidebar:
        st.image("https://raw.githubusercontent.com/IrfanAliGit77/Belajar-Analisis-Data-dengan-Python--ID-Camp-X-Dicoding-Academy/main/submission/dashboard/Logo.PNG")
